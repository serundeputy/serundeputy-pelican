...
<img src="/images/vendor-backdrop-coder.png" width="100%" />
</div>
...
<div style="text-align: center;">
  <img src="/images/serundrop-travis.png" width="100%" alt="Screenshot of Travis CI config" />
</div>
...
<div style="text-align: center;">
  <img src="/images/serundrop-travis-fail.png" width="100%" alt="Screenshot of Travis CI run failng" />
</div>

And the corresponding run after fixing the errors:

<div style="text-align: center;">
  <img src="/images/serundrop-travis-pass.png" width="100%" alt="Screenshot of Travis CI run passing" />
</div>
